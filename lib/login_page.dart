...
import 'package:blungogo/login_button.dart';
    ...
    if (validateAndSave()) {
      try {
        String userId = _formType == FormType.login
            ...
            : await widget.auth.createUser(_email, _password, _nick);
        setState(() {
          _authHint = 'Signed In\n\nUser id: $userId';
        });
  ...
  List<Widget> nick() {
    return [
      padded(
        ...
        autocorrect: false,
        validator: (val) => val.isEmpty ? 'Nick cannot be empty.' : null,
      ...
      case FormType.login:
        return [
          ...
          new FlatButton(
              ...
              child: new Text("No account? Register here"),
